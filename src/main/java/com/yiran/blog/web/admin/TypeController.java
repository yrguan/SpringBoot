package com.yiran.blog.web.admin;

import com.yiran.blog.po.Type;
import com.yiran.blog.service.TypeService;
...
public class TypeController {
    ...
    public String post(@Valid Type type, BindingResult result, RedirectAttributes attributes){
        ...
        if(t == null){
            attributes.addFlashAttribute("message", "action fail");
        }else{
            attributes.addFlashAttribute("message","action success");
        }
